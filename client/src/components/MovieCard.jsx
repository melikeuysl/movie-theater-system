...
const MovieCard = ({movie}) => {
  ...
  return (
    <div className='flex flex-col justify-between p-3 bg-gray-800
     rounded-2xl hover:-traslate-y-1 transition duration-300 w-66'>
      ...
      <p className='text-sm tex-gray-400 mt-2 '>{new Date(movie.release_date).getFullYear} - {movie.genres.slice(0,2).map
