...
const Navbar = () => {
  ...
  return (
    <div className=' fixed top-0 left-0 z-50 w-full flex items-center justify-between px-6 md:px-16 lg:px-36 py-5'>
      ...
      <img src={assets.logo} alt=""  className='w-32 md:w-40 lg:w-48 h-auto rounded-3xl border border-[#4D55CC]/30 transition'/>
      </Link>
      ...
      min-md:rounded-full backdrop-blur bg-black/70 md:bg-black/30 md:border
